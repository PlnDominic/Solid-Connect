        ...
        <Pressable
          ...
          onPress={() =>
            navigation.navigate('NewRequest', {
              initialCategoryName: provider.provider_category ?? undefined,
              preferredProviderId: provider.id,
              preferredProviderName: provider.full_name,
              initialDescription: `Looking for help from ${provider.full_name} (${provider.provider_category}).`,
            })
          }
        >
          <Text style={styles.ctaLabel}>
            Request {provider.provider_category ? provider.provider_category : 'this trade'}
          </Text>
        </Pressable>
      </View>
    </Screen>
