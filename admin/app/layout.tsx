    ...
    <html><body>
      <div className="shell">
        <aside className="side">
          <div className="brand">
            <img src="/logo.jpeg" alt="" width={28} height={28} />
            <div>Solid Connect<small>Operations</small></div>
          </div>
          <div className="nav-section">
            <nav className="nav">
              <Link href="/analytics">
                <NavIcon d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0a1 1 0 01-1-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 01-1 1" />
                Analytics
              </Link>
              ...
              <span>
                <NavIcon d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                Disputes
              </span>
              <span>
